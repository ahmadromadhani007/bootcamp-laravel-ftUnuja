										...
										<div class="card-header border-0 pt-5">
											...
											<div class="card-toolbar">
												...
												<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
													data-kt-menu="true" id="kt_menu_61485886f2f90">
													<!--begin::Header-->
													<div class="px-7 py-5">
										...
										<div class="card-body pt-5">
											...
											<div class="d-flex align-items-center mb-7">
												...
												<div class="d-flex flex-column">
													<a href="#"
														class="text-dark text-hover-primary fs-6 fw-bolder">Project
														Briefing</a>
											...
											<div class="d-flex align-items-center mb-7">
												...
												<div class="d-flex flex-column">
													<a href="#"
														class="text-dark text-hover-primary fs-6 fw-bolder">Concept
														Design</a>
											...
											<div class="d-flex align-items-center mb-7">
												...
												<div class="d-flex flex-column">
													<a href="#"
														class="text-dark text-hover-primary fs-6 fw-bolder">Functional
														Logics</a>
											...
											<div class="d-flex align-items-center">
												...
												<div class="d-flex flex-column">
													<a href="#"
														class="text-dark text-hover-primary fs-6 fw-bolder">Testing</a>
									...
									<div class="card card-xl-stretch mb-5 mb-xl-8">
										...
										<div class="card-header border-0 pt-5">
											...
											<div class="card-toolbar">
												...
												<!--begin::Menu 1-->
												<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
													data-kt-menu="true" id="kt_menu_6148588700a53">
													<!--begin::Header-->
													<div class="px-7 py-5">
														<div class="fs-5 text-dark fw-bolder">Filter Options</div>
													</div>
									...
									<div class="card card-xl-stretch mb-xl-8">
										...
										<div class="card-header align-items-center border-0 mt-4">
											...
											<div class="card-toolbar">
												...
												<!--begin::Menu 1-->
												<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
													data-kt-menu="true" id="kt_menu_6148588700dd8">
													<!--begin::Header-->
													<div class="px-7 py-5">
														<div class="fs-5 text-dark fw-bolder">Filter Options</div>
													</div>
										...
										<div class="card-body pt-3">
											...
											<div class="d-flex align-items-sm-center mb-7">
												...
												<div class="d-flex flex-row-fluid flex-wrap align-items-center">
													<div class="flex-grow-1 me-2">
														<a href="#"
															class="text-gray-800 fw-bolder text-hover-primary fs-6">Cup
															&amp; Green</a>
											...
											<div class="d-flex align-items-sm-center mb-7">
												...
												<div class="d-flex flex-row-fluid flex-wrap align-items-center">
													<div class="flex-grow-1 me-2">
														<a href="#"
															class="text-gray-800 fw-bolder text-hover-primary fs-6">Nike
															&amp; Blue</a>
														<span class="text-muted fw-bold d-block pt-1">Size: 87KB</span>
													</div>
													<span
														class="badge badge-light-success fs-8 fw-bolder my-2">Success</span>
												</div>
												<!--end::Title-->
											</div>
											<!--end::Item-->
											...
											<div class="d-flex align-items-sm-center">
												...
												<div class="d-flex flex-row-fluid flex-wrap align-items-center">
													<div class="flex-grow-1 me-2">
														<a href="#"
															class="text-gray-800 fw-bolder text-hover-primary fs-6">Red
															Boots</a>
